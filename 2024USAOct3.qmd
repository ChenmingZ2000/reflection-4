...
## 1. Data Acquisition
The dataset used in this analysis is available [https://usa.ipums.org/usa/index.shtml]. We use IPUMS to access the 2022 ACS and focus on each state (STATEICP) that had a doctoral degree as their highest educational attainment (EDUC).

## 2. Overview of Ratio Estimators
Ratio estimators provide a method for estimating population parameters by using auxiliary information. Here's a brief summary...
